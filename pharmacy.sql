...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2022 at 06:39 PM
...
BEGIN
SELECT P_ID,SUP_ID,MED_ID,P_QTY,P_COST,PUR_DATE,MFG_DATE,EXP_DATE FROM purchase where EXP_DATE < CURDATE() ORDER BY SUP_ID;
END$$
...
CREATE TABLE `meds` (
  ...
  `VENDOR_ADDRESS` varchar(80) DEFAULT NULL
) ;
...
INSERT INTO `meds` (`MED_ID`, `MED_NAME`, `MED_QTY`, `CATEGORY`, `MED_PRICE`, `LOCATION_RACK`,`VENDOR_ADDRESS`) VALUES
('123001', 'Dolo 650 MG', 12, 'Tablet', '1.00', 'rack 5','Chennai, Tamil Nadu'),
('123002', 'Panadol Cold & Flu', 90, 'Tablet', '2.50', 'rack 6','Chennai, Tamil Nadu'),
('123003', 'Livogen', 15, 'Capsule', '5.00', 'rack 3','Banglore'),
('123004', 'Gelusil', 440, 'Tablet', '1.25', 'rack 4','Chennai'),
('123005', 'Cyclopam', 120, 'Tablet', '6.00', 'rack 2','Chennai, Tamil Nadu'),
('123006', 'Benadryl 200 ML', 35, 'Syrup', '50.00', 'rack 10','Hyderabad'),
('123007', 'Lopamide', 15, 'Capsule', '5.00', 'rack 7','Banglore'),
('123008', 'Vitamic C', 90, 'Tablet', '3.00', 'rack 8','Hyderabad'),
('123009', 'Omeprazole', 35, 'Capsule', '4.00', 'rack 3','Banglore'),
('123010', 'Concur 5 MG', 24, 'Tablet', '3.50', 'rack 9','Trichy'),
('123011', 'Augmentin 250 ML', 115, 'Syrup', '80.00', 'rack 7','Chennai, Tamil Nadu');
...
('1001', '136', '123010', 200, '1500.50', '2022-03-01', '2019-05-05', '2024-05-10'),
('1002', '123', '123002', 1000, '3000.00', '2022-02-01', '2018-06-01', '2022-04-12'),
('1003', '145', '123006', 20, '800.00', '2022-04-22', '2017-02-05', '2023-03-01'),
('1004', '156', '123004', 250, '1000.00', '2022-04-02', '2022-05-06', '2023-05-06'),
('1005', '123', '123005', 200, '1200.00', '2022-02-01', '2019-08-02', '2026-04-01'),
('1006', '162', '123010', 500, '1500.00', '2019-04-22', '2018-01-01', '2021-05-05'),
('1007', '123', '123001', 500, '450.00', '2022-01-02', '2019-01-05', '2024-03-06'),
('1008', '123', '123004', 20, '80.00', '2021-01-02', '2020-12-29', '2022-03-24');
...
(1, '987101', '2022-04-15', '13:23:03', '180.00', '4567009'),
(2, '987106', '2022-04-21', '20:19:31', '585.00', '1'),
(3, '987103', '2022-04-15', '11:23:53', '120.00', '4567010'),
(4, '987104', '2022-04-14', '18:20:00', '955.00', '4567006'),
(5, '987103', '2022-04-21', '15:24:43', '45.00', '1'),
(6, '987102', '2022-03-11', '10:24:43', '140.00', '4567001'),
(7, '987105', '2022-04-24', '00:25:54', '350.00', '1'),
(8, '987104', '2022-04-24', '00:47:47', '35.00', '4567001'),
(12, '987103', '2022-04-24', '19:33:16', '60.00', '1'),
(13, '987104', '2022-04-24', '21:15:56', '62.50', '4567001'),
(15, '987107', '2022-12-04', '18:39:46', '420.00', '1'),
(16, '987106', '2022-12-04', '18:52:21', '30.00', '1'),
(17, '987103', '2022-12-04', '19:35:56', '57.50', '1'),
(18, '987105', '2022-12-04', '19:36:56', '160.00', '4567001'),
(20, '987103', '2022-12-04', '22:53:18', '150.00', '4567001');
...
INSERT INTO `sales_items` (`SALE_ID`, `MED_ID`,`S_DATE`, `SALE_QTY`, `TOT_PRICE`) VALUES
(1, '123001','2022-04-15', 20, '20.00'),
(1, '123011','2022-04-15', 2, '160.00'),
(2, '123003','2022-04-21', 75, '225.00'),
(2, '123005','2022-04-21', 60, '360.00'),
(3, '123008','2022-04-15', 40, '120.00'),
(4, '123010','2022-04-14', 250, '875.00'),
(4, '123011','2022-04-14', 1, '80.00'),
(5, '123001','2022-04-21', 45, '45.00'),
(6, '123006','2022-03-11', 2, '100.00'),
(6, '123009','2022-03-11', 10, '40.00'),
(7, '123001','2022-04-24', 100, '100.00'),
(7, '123003','2022-04-24', 50, '250.00'),
(8, '123001','2022-04-24', 10, '10.00'),
(8, '123002','2022-04-24', 10, '25.00'),
(12, '123005','2022-04-24', 10, '60.00'),
(13, '123002','2022-04-24', 25, '62.50'),
(15, '123005','2022-12-04', 45, '270.00'),
(15, '123006','2022-12-04', 3, '150.00'),
(16, '123008','2022-12-04', 10, '30.00'),
(17, '123004','2022-12-04', 10, '12.50'),
(17, '123007','2022-12-04', 5, '25.00'),
(17, '123009','2022-12-04', 5, '20.00'),
(18, '123011','2022-12-04', 2, '160.00'),
(20, '123005','2022-12-04', 25, '150.00');
